...
mod tests {
    ...
    use shinri_theory::{AtomRegistry, EqualityEngine, EqJust, TCheck, TheoryCtx, TheorySolver};
    use shinri_sat::Effort;
    ...
    fn row1_emits_select_equals_stored_value() {
        ...
        match arrays.check(&mut cx, Effort::Full) {
            ...
            other => panic!("expected Split, got {:?}", match other {
                TCheck::Sat => "Sat",
    ...
    fn row2_emits_disjunctive_split_when_index_undecided() {
        ...
        match arrays.check(&mut cx, Effort::Full) {
            ...
            other => panic!("expected 2-atom Split, got {:?}", match other {
                TCheck::Sat => "Sat",
                TCheck::Conflict(_) => "Conflict",
                TCheck::Split(_) => unreachable!(),
            }),
